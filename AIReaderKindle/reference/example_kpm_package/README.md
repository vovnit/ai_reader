# Example Package
This is an example KPM package to demonstrate the file layout

## Turning this package into a .kpkg file
```code
python kpm-helper.py package pack . ..
```
...
1 directory, 1 file
The manifest file will now be initialised to target all platforms (see: targeting specific platforms)
